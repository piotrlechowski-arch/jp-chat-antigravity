    ...
    <div className="flex flex-col h-screen max-w-4xl mx-auto p-4">
      ...
      <form onSubmit={sendMessage} className="flex gap-2 pt-4 border-t">
        <input
          ...
          className="flex-1 border border-gray-300 rounded-lg px-4 py-2 text-gray-900 placeholder-gray-500 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          disabled={isLoading}
        />
        <button
          type="submit"
